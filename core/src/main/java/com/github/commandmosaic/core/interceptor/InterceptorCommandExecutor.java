...
public final class InterceptorCommandExecutor implements CommandExecutor {
    ...
    public <R, C extends Command<R>> R execute(
        ...
        return commandInterceptor.intercept(commandClass, parameters, context, interceptorChain);
    }
    // CPD-ON
    ...
    public String toString() {
        final StringBuilder sb = new StringBuilder("InterceptorCommandExecutor{");
        sb.append("commandInterceptor=").append(commandInterceptor);
        sb.append(", interceptorChain=").append(interceptorChain);
        sb.append('}');
        return sb.toString();
    }
}

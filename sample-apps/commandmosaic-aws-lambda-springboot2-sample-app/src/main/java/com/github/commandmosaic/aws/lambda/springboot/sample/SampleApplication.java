...
public class SampleApplication {
	...
	public CommandDispatcherConfiguration commandDispatcherConfiguration() {
		return CommandDispatcherConfiguration.builder()
				.rootPackageFromClass(getClass())
				.build();
	}

	@Service
	static class HelloWorldGreetingService implements GreetingService {

		@Override
		public String getMessage(String personName) {
			return String.format("Hello %s, welcome to Lambda-Spring Boot world", personName);
		}
	}
}